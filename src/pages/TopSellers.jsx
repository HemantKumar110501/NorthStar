...
export default function TopSellers() {
  ...
  // Pre-filter products for top sellers section
  const topSellerProducts = useMemo(() => {
    return products.filter((p) => p.section === 'top-sellers');
  }, []);

  // Extract categories dynamically from top sellers
  const categories = useMemo(() => {
    const allCats = topSellerProducts.flatMap((p) => p.category.split(', '));
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [topSellerProducts, searchTerm, selectedCategories, sortBy]);

  return (
    <div className="top-sellers-page">
      {/* Page Header Banner */}
      <div className="sellers-hero-banner">
        <div className="container">
          ...
          <h1 className="sellers-hero-title">TOP SELLERS</h1>
          <p className="sellers-hero-subtitle">
            Shop our best-selling clothing items. Customer favorites and top trending picks.
          </p>
        </div>
      </div>
        ...
        <div className="products-layout-grid">
          ...
          <aside className="filters-sidebar">
            <div className="filter-section search-filter-box">
              <h4 className="filter-title">Search Sellers</h4>
          ...
          <main className="products-list-panel">
            <div className="desktop-toolbar">
              <span className="results-count">
                ...
                <strong>{topSellerProducts.length}</strong> best sellers
              </span>
            ...
            {filteredProducts.length === 0 ? (
              <div className="no-products-found">
                ...
                <p>
                  We couldn't find any products matching your search criteria in our best sellers catalog.
                </p>
                <button
                  type="button"
