...
export default function AllProducts() {
  ...
  const categories = useMemo(() => {
    const allCats = products.flatMap((p) => p.category.split(', '));
      ...
      <div className="products-hero-banner">
        <div className="container">
          ...
          <p className="products-hero-subtitle">
            Explore our curated catalog of modern lifestyle and premium apparel.
          </p>
        </div>
      </div>
          ...
          <main className="products-list-panel">
            ...
            {filteredProducts.length === 0 ? (
              <div className="no-products-found">
                ...
                <p>
                  We couldn't find any products matching your search criteria. Try removing some filters or
